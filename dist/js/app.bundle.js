...
var app = new _vue2.default({
  ...
  methods: {
    ...
    search: function search(type, text) {
      eventHub.$emit("search-start", { type: type, text: text });
    },
...
module.exports = new Vue({
  ...
  methods: {
    ...
    search: function search(payload) {
      ...
      var method = searchMethods[payload.type];

      if (method) {
        method(payload.text).then(function (result) {
          eventHub.$emit("search-ended");
          eventHub.$emit("search-result", { query: payload.text, type: payload.type, result: result });
        }).catch(function (err) {
          var details = {};
...
function _search(criteria, val) {
  return new Promise(function (resolve, reject) {
    axios.get(apiURL + '?' + criteria + '=' + val).then(function (response) {
...
module.exports = function () {
  function NetflixAPI() {
    _classCallCheck(this, NetflixAPI);
  }

  _createClass(NetflixAPI, null, [{
    key: 'searchTitle',
    value: function searchTitle(_val) {
      return _search('title', _val);
    }
  }, {
    key: 'searchDirector',
    value: function searchDirector(_val) {
      return _search('director', _val);
    }
  }, {
    key: 'searchActor',
    value: function searchActor(_val) {
